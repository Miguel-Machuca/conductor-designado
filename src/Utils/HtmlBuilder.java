...
public class HtmlBuilder {
    ...
    return "<h1>Casos de uso del sistema para EMAIL</h1>"
            ...
            + "<ul>"            
            + "<li>1) El formato para fechas es AAAA-MM-DD, por ejemplo 1998-03-14.</li>"
            + "<li>2) El sexo se coloca masculino y femenino.</li>"
            + "<li>3) Solo se aceptaran numeros de celular de hasta 12 digitos.</li>"
            + "<li>4) Solo se aceptan contraseñas de 8 a 10 caracteres, minimo una minuscula, mayuscula, numero y caracter especial.</li>"            
            + "<li>5) El estado del personal puede ser activo o inactivo</li>"
            + "<li>6) La categoria de la licencia puede ser A,B,C o P</li>"           
            + "<li>7) El estado del vehiculo puede ser \"activo\", \"inactivo\", \"en servicio\", \"fuera de servicio\"</li>"            
            + "</ul>"                
            + "<table>"
            + "<tbody>"
            + "<tr><th colspan=\"3\">CU1. Gestión de Usuarios(Personal, Conductores, Clientes).</th></tr>"
            + "<tr><td class=\"highlight\">Registrar Usuario</td></tr>"
            + "<tr><td>Formato: usuario agregar [nombre, apellido, email, contraseña, celular, fecha de nacimiento, genero] </td></tr>"
            + "<tr><td>Ejemplo: usuario agregar [Andres, chavez, andy@gmail.com, 12345678, 63489070, 1998-06-21, masculino] </td></tr>"
            + "<tr><td class=\"highlight\">Modificar Usuario</td></tr>"
            + "<tr><td>Formato: usuario editar [id del usuario, nombre, email, contraseña, celular, fecha de nacimiento, genero] </td></tr>"
            + "<tr><td>Ejemplo: usuario editar [1, jose, lopez@gmail.com, 12345678, 63489070, 1998-06-21, masculino] </td></tr>"
            + "<tr><td class=\"highlight\">Eliminar Usuario</td></tr>"
            + "<tr><td>Formato: usuario eliminar [id del usuario] </td></tr>"
            + "<tr><td>Ejemplo: usuario eliminar [1] </td></tr>"
            + "<tr><td class=\"highlight\">Registrar Cliente</td></tr>"
            + "<tr><td>Formato: cliente agregar [nombre, apellido, email, contraseña, celular, fecha de nacimiento, genero, cedula de identidad] </td></tr>"
            + "<tr><td>Ejemplo: cliente agregar [carlos, ramirez, carlos@gmail.com, 12345678, 63489070, 1998-06-21, masculino, 7987833] </td></tr>"
            + "<tr><td class=\"highlight\">Modificar Cliente</td></tr>"
            + "<tr><td>Formato: cliente editar [id del cliente, nombre, apellido, email, contraseña, celular, fecha de nacimiento, genero, cedula de identidad] </td></tr>"
            ...
            + "<tr><td>Formato: conductor agregar [nombre, apellido, email, contraseña, celular, fecha de nacimiento, genero, Nº de licencia, categoria de licencia, fecha de vencimiento de licencia] </td></tr>"
            + "<tr><td>Ejemplo: conductor agregar [roger, sossa, roger@gmail.com, 126455678, 63489070, 1998-06-22, masculino, 76364, A, 2025-08-22] </td></tr>"
            + "<tr><td class=\"highlight\">Modificar Conductor</td></tr>"
            + "<tr><td>Formato: conductor editar [id del conductor, nombre, apellido, email, contraseña, celular, fecha de nacimiento, genero, Nº de licencia, categoria de licencia, fecha de vencimiento de licencia] </td></tr>"
            ...
            + "<tr><td>Formato: personal agregar [nombre, apellido, email, contraseña, celular, fecha de nacimiento, genero, salario, estado, cargo] </td></tr>"
            + "<tr><td>Ejemplo: personal agregar [Andrea, chavez, Andrea@gmail.com, 12345678, 63489070, 1998-06-21, femenino, 2500.7, activo, empleado] </td></tr>"
            + "<tr><td class=\"highlight\">Modificar Personal</td></tr>"
            + "<tr><td>Formato: personal editar [id del personal, nombre, apellido, email, contraseña, celular, fecha de nacimiento, genero, salario, estado, cargo] </td></tr>"
            ...
            + "<tr><td>Ejemplo: servicio agregar [taxi, servicio de transporte privado] </td></tr>"
            ...
            + "<tr><td>Ejemplo: servicio editar [1, taxi, servicio de transporte publico] </td></tr>"
            + "<tr><td class=\"highlight\">Eliminar Servicio</td></tr>"
            + "<tr><td>Formato: servicio eliminar [id del servicio] </td></tr>"
            + "<tr><td>Ejemplo: servicio eliminar [1] </td></tr>"
            ...
            + "<tr><td class=\"highlight\">Ver gastos</td></tr>"
            + "<tr><td>Formato: reportes gastos[fecha inicial , fecha final ]</td></tr>"
            + "<tr><td>Ejemplo: reportes gastos[2024-01-01,2024-05-01]</td></tr>"
            + "<tr><td class=\"highlight\">Ver transacciones</td></tr>"
            + "<tr><td>Formato: reportes transacciones[fecha inicial , fecha final ]</td></tr>"
            + "<tr><td>Ejemplo: reportes transacciones[2024-01-01,2024-05-01]</td></tr>"
    ...
    private static String getUseCaseEmpleado(){
        return "<h1>Casos de uso del sistema para EMAIL</h1>"
                ...
                + "<tr><td>Ejemplo: gastosOperativos agregar[120.3,2024-10-15,pago de almuerzos]</td></tr>"                
                ...
                + "<tr><td>Ejemplo: gastosOperativos editar[6, 122.3,2024-09-12,pago de biaticos editado]</td></tr>"                
    ...
    private static String getUseCaseConductor(){
        return "<h1>Casos de uso del sistema para EMAIL</h1>"
                ...
                + "<tr><th colspan=\"3\">CU9. Gestión de Viajes</th></tr>"
                + "<tr><td class=\"highlight\">Notificar Viaje</td></tr>"
                + "<tr><td>Formato: viaje notificar[correo del cliente]</td></tr>"
                + "<tr><td>Ejemplo: viaje notificar[carlos@gmail.com]</td></tr>"  
                + "<tr><td class=\"highlight\">Terminar Viaje</td></tr>"
                + "<tr><td>Formato: viaje terminar[]</td></tr>"
                + "<tr><td>Ejemplo: viaje terminar[]</td></tr>" 
    ...
    private static String getUseCaseCliente(){
        return "<h1>Casos de uso del sistema para EMAIL</h1>"
                ...
                + "<tr><td class=\"highlight\">Realizar pago</td></tr>"
                + "<tr><td>Formato: pago agregar[id del viaje,id del metodo de pago]</td></tr>"
                + "<tr><td>Ejemplo: pago agregar[1,1]</td></tr>"                
               
                + "<tr><th colspan=\"3\">CU9. Gestión de Viajes</th></tr>"
                + "<tr><td class=\"highlight\">Registrar Viaje</td></tr>"
                + "<tr><td>Formato: viaje solicitar   [id del servicio, link de la ruta]</td></tr>"
                + "<tr><td>Ejemplo: viaje solicitar   [1, https://maps.app.goo.gl/kL8J44qZz8xNASSL6]</td></tr>"  
